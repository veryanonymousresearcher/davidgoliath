...
def parse_args():
    ...
    parser.add_argument("--t_path", type=str, default=str(paths.model_path("suffix")))
    parser.add_argument("--t_model_name", type=str, default="BPI12_gpt2_runpkjmgoop.pth")
    ...
    parser.add_argument("--n_layers", type=int, default=8)  # GPT-2 has 12
